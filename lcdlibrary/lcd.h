...
/**
 @brief    Define character on LCD.

 Writes to one of the 8 character memory slots. Note, bits 0-4 of each
 byte are actually used.
 @param    addr character address (will be masked to bottom three bits)
 @param    data the 8 lines of character data
 @return   none
*/
extern void lcd_cgram(uint8_t addr, const uint8_t data[8]);
